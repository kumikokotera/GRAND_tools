...
def do_interpolation_hdf5(desired, InputFilename, OutputFilename, antennamin=0, antennamax=159, EventNumber=0,shower_core=np.array([0,0,0]), DISPLAY=False, usetrace='efield'):
    ...
    '''
    #print(shower_core)
    DEVELOPMENT=False #only for developing, when working on the starshape patern and trying to interpolate the random antenas on the starshape (or it will crash)
    #DISPLAY=True
