...
path = "/Users/benoitl/Documents/GRAND/Data_grids/125trihex_nring10/"
plot_path = '/Users/benoitl/Documents/GRAND/Data_grids/125trihex_nring10/plots'
...
if False:
    lay1.make_all_plots()
    lay2.make_all_plots()
    lay1.plot_2d_efficiency(7, 7, color='C0')
    lay2.plot_2d_efficiency(7, 7, color='C1')
    ...
    #lay_rand_5.plot_2d_efficiency(7, 7)
if False:
    # creating the trihex 250 grid out of the trixhex 125
    mask_tri250 = masks.make_coarse_out_of_fine_trihex(250, 'trihex', 125, 10) 
    lay_tri250 = layout.Layout(path, pos, mask_tri250, "tri250", threshold, n_trig_thres, input_n_ring, primary)
    lay_tri250.make_all_plots()
    lay_tri250.plot_2d_efficiency(7, 7)

    mask_hex250 = masks.make_coarse_out_of_fine_trihex(250, 'hexhex', 125, 10) 
    lay_hex250 = layout.Layout(path, pos, mask_hex250, "hex250", threshold, n_trig_thres, input_n_ring, primary)
    lay_hex250.make_all_plots()
    lay_hex250.plot_2d_efficiency(7, 7)

    mask_tri375 = masks.make_coarse_out_of_fine_trihex(375, 'trihex', 125, 10) 
    lay_tri375 = layout.Layout(path, pos, mask_tri375, "tri375", threshold, n_trig_thres, input_n_ring, primary)
    lay_tri375.make_all_plots()
    lay_tri375.plot_2d_efficiency(7, 7)

    mask_hex375 = masks.make_coarse_out_of_fine_trihex(375, 'hexhex', 125, 10) 
    lay_hex375 = layout.Layout(path, pos, mask_hex375, "hex375", threshold, n_trig_thres, input_n_ring, primary)
    lay_hex375.make_all_plots()
    lay_hex375.plot_2d_efficiency(7, 7)

    mask_tri500 = masks.make_coarse_out_of_fine_trihex(500, 'trihex', 125, 10) 
    ...
    lay_tri500.plot_2d_efficiency(7, 7)

    mask_hex500 = masks.make_coarse_out_of_fine_trihex(500, 'hexhex', 125, 10) 
    ...
    mask_hex1000 = masks.make_coarse_out_of_fine_trihex(1000, 'hexhex', 125, 10) 
    lay_hex1000 = layout.Layout(path, pos, mask_hex500, "hex1000", threshold, n_trig_thres, input_n_ring, primary)
...
if False:
    ...
    lay_trihex125_nring0.plot_2d_efficiency(7, 7, 'C3')
    ...
    lay_trihex125_nring1.plot_2d_efficiency(7, 7, 'C4')
if False:
    ...
    lay_trihex125_nring2.plot_2d_efficiency(7, 7, 'C5')
...
if True:
    ...
    lay_trihex125_nring3.plot_2d_efficiency(7, 7, 'C6')
