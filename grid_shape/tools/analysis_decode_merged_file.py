...
ua.create_ev_select_from_config_merged(
    events_data_dir,
    merged_file_dir,
    config_merged, 
    threshold,
...
rect_steps = config_merged["layouts"]["rect"]
...
ev_select_rect = [
    ...
    for step in rect_steps
]
ev_select_rect = np.concatenate([*ev_select_rect])  




if 1==1:
    ev_select = ev_selects_rect
    layout = "rect"
